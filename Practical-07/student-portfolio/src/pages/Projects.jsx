    ...
    <div className="projects-container">
      ...
      <div className="featured-banner card">
        <div className="featured-banner-text">
          <span className="featured-pill">🌟 Featured Practical 7</span>
          <h2>Full-Stack Task Manager with JWT Auth</h2>
          <p>
            React 19, Express 5 REST API, JWT Authentication & MongoDB Atlas with status tabs, PDF reports, and audit logs.
          </p>
        </div>
